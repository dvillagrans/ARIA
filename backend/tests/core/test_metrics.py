...
class TestMetricRegistry:
    ...
    def test_http_requests_total_is_counter(self):
        ...
        assert aria_http_requests_total._name == "aria_http_requests"
    ...
    def test_records_created_total_is_counter(self):
        ...
        # prometheus_client strips _total suffix from Counter names
        assert aria_records_created_total._name == "aria_records_created"
    ...
    def test_briefing_cache_hits_total_is_counter(self):
        ...
        assert aria_briefing_cache_hits_total._name == "aria_briefing_cache_hits"
        assert set(aria_briefing_cache_hits_total._labelnames) == {"result"}
    ...
    def test_context_note_updates_total_is_counter(self):
        ...
        assert aria_context_note_updates_total._name == "aria_context_note_updates"

    # --- Connector metrics ---

    def test_connector_events_total_is_counter(self):
        assert isinstance(aria_connector_events_total, Counter)
        assert aria_connector_events_total._name == "aria_connector_events"
    ...
    def test_connector_errors_total_is_counter(self):
        ...
        assert aria_connector_errors_total._name == "aria_connector_errors"
